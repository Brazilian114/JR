...
export class CheckinPage {
      ...
      let profileModal = this.modalCtrl.create(RecipesmodalPage, { oClient: oClient, oReciptNo: oReceipt, oReceiptType: listType, oBook: listBook});
        ...
        profileModal.onDidDismiss(data =>{
          ...
          if(data == undefined){
            ...
            console.log("this.oReceipt",this.oReceipt);
  ...
  doSaveHeader(oClient, listBook, oReceipt, oDate, oInc, listStation, listWhses, listZone, listType, oContainer, oSupplier, oRemarks, oStatus, oInvoice, oInvoice_Date, oAsn_flag){
    if(oReceipt == undefined){
      ...
      if(listBook == undefined || listBook == ""){
        ...
        this.service.update_receipt_header_new(oClient, listBook, oReceipt, oDate, oInc, listStation, listWhses, listZone, listType, oContainer, oSupplier, "", oRemarks, "", oStatus, this.oUsername, oInvoice, oInvoice_Date, oAsn_flag ).then((res)=>{
