...
@IonicPage(
  {name:'itemWObyTaskPage',
  segment: 'itemWObyTask'}
)
@Component({
...
export class itemWObyTaskPage {
  ...
  doSelectItem(itemNo, description, qty, uom, location_from, order_no, pallet_from, delivery_date, customer, task_no
    , activity, location_to, warehouse_from, warehouse_to, zone_dest, zone_from,QTY_Dec, route){
    ...
    , 'warehouse_to': warehouse_to, 'zone_dest': zone_dest, 'zone_from': zone_from,'QTY_Dec':QTY_Dec,'route':route };
