  ...
  doSaveStockCount(oSttRef, oRecNum, oWh, OLoc, oPallet, oClient, oItem, oBarcode, oUOM, oSQty, oCQty, oGrade, oLotNo, oBatNo, oExpDate, oProdDate, oSize, oColor, oClass, oOwner){
        ...
        if(oSttRef == undefined || oSttRef == ""){
          ...
          if(this.isenabledLot == true && oLotNo == ""){
            ...
            console.log('1');
              console.log(oSttRef, oRecNum, oWh, OLoc, oPallet, oClient, oItem, oUOM, oSQty, oCQty, oGrade, oLotNo, oBatNo, oExpDate, oProdDate, oSize, oColor, oClass, oOwner, this.oUsername);
              this.service.update_Stock_Count(oSttRef, oRecNum, oWh, OLoc, oPallet, oClient, oItem, oBarcode, oUOM, oSQty, oCQty, oGrade, oLotNo, oBatNo, oExpDate, oProdDate, oSize, oColor, oClass, oOwner, this.oUsername).then((res)=>{
                this.data_save = res;
